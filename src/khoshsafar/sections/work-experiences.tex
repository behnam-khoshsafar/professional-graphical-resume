...
\begin{jrsection}{Work Experience}
    ...
    \begin{jrdescription}
        ...
        - Responsible for designing and implementing the Installment module.\linebreak
        - Responsible for designing and implementing the Refund module.\linebreak
        - Responsible for designing and implementing the Report module.\linebreak
    \end{jrdescription}
    }
    \jexperience{
        ...
        \begin{jrdescription}
            - Worked as a member of the development team.\linebreak
            - Responsible for designing and implementing the Order module.\linebreak
            - Responsible for designing and implementing the Notification module.\linebreak
            - Responsible for designing and implementing the Report module.\linebreak
        \end{jrdescription}
    }
    \jexperience{
    ...
    \jexperience{
        ...
        \begin{jrdescription}
            - Worked as a member of the development team.\linebreak
            - Responsible for designing and implementing the Sale module.\linebreak
            - Responsible for designing and implementing the Inventory module.\linebreak
        \end{jrdescription}
    }
\end{jrsection}
